...
if not client.is_user_authorized():
    ...
    g_index = input(gr+"Masukkan nomor: "+re)
    ...
    for user in users:
        ...
        if n % 50 == 0:
    	    ...
    	    try:
    	        ...
    	        print(gr+"[+] Menunggu 60-180 sec ...")
    	        time.sleep(random.randrange(60, 180))
    	    except PeerFloodError:
    	        print(re+"[!] Getting Flood Errors from Telegram. \n[!] Script is stopping for now. \n[!] Please try again after some time.")
    	    except UserPrivacyRestrictedError:
    	        print(re+"[!] Pengaturan privasi pengguna tidak mengizinkan Anda melakukan ini. Melewatkan ...")
    	    except:
    	        traceback.print_exc()
    	        print(re+"[!] Kesalahan yang tidak terduga ...")
    	        continue
